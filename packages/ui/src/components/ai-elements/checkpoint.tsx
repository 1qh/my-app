...
import { Tooltip, TooltipContent, TooltipTrigger } from '@workspace/components/ui/tooltip'
...
export const CheckpointIcon = async ({ children, className, ...props }: CheckpointIconProps) =>
