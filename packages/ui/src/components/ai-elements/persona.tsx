...
const PersonaWithModel = memo(async ({ children, rive, source }: PersonaWithModelProps) => {
...
const PersonaWithoutModel = memo(async ({ children }: PersonaWithoutModelProps) => children)
